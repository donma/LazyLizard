    ...
    public class DotSkype
    {
        ...
        public string GetRegisterToken(string skypeToken)
        {
            ...
            try
            {
                ...
                registTokenSource = registTokenSource.Split(";")[0];
        ...
        public void SendIImage(string registrationToken, string objectId, string userId, string imageName, string text)
        {
            ...
            HttpWebRequest httpWebRequest = WebRequest.Create(MsgHost + "users/ME/conversations/" + userId + "/messages") as HttpWebRequest;
